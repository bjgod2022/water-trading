...
const stockIndex = ['sh000001', 'sz399001', 'sz399006','sz399005','sh000010','sh000016', 'sh000300','sh000905',] // 三大指数
...
const comparePrice = (value, compare) => {
  ...
  return value > compare ? 'gain-more' : (value < compare ? 'gain-less' : 'gain-ping')
}

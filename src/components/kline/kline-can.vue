<template>
  <div>
    ...
    <div id="app-conainer" :style="{ top: top + 'px' }">
      <component :is="current_app" :index-based="index_based" :night="night" :resetkey="resetkey" :ext="extensions" />
    </div>
    <div class="app-tags">
      <app-tag v-for="app of apps" :id="app.id" :key="app.id" :sel="current === app.id" @select="onselect" />
    </div>
  </div>
</template>

  ...
  <span>
    <div id="tvjs-header">
      ...
      <span class="night-mode">
        <input v-model="night" type="checkbox">
        <label>NM</label>
      </span>
    ...
    <div id="app-conainer" :style="{ top: top + 'px' }">
      <component v-bind:is="current_app" :night="night" :resetkey="resetkey" :ext="extensions">
      </component>
    </div>
    ...
    <trading-vue :id="can" :data="chart" :width="width" :height="430" :title-txt="stock.name" :overlays="overlays"
      :toolbar="true" :timezone="8" :chart-config="{ DEFAULT_LEN: 57 }" :index-based="index_based"
...
import MACD from "@/components/overlays/MACD/MACD.vue"; // New import
import Histogram from "@/components/overlays/Histogram/Histogram.vue"; // New import
